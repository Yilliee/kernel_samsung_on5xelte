...
#define SCSC_ERR_SDEV(sdev, fmt, args...) \
	SCSC_TAG_ERR_SDEV(sdev, WLBT, SCSC_PREFIX fmt, ## args)
#define SCSC_WARNING_SDEV(sdev, fmt, args...) \
	SCSC_TAG_WARNING_SDEV(sdev, WLBT, SCSC_PREFIX fmt, ## args)
#define SCSC_INFO_SDEV(sdev, fmt, args...) \
	SCSC_TAG_INFO_SDEV(sdev, WLBT, SCSC_PREFIX fmt, ## args)

#define SCSC_ERR_NDEV(ndev, fmt, args...) \
	SCSC_TAG_ERR_NDEV(ndev, WLBT, SCSC_PREFIX fmt, ## args)
#define SCSC_WARNING_NDEV(ndev, fmt, args...) \
	SCSC_TAG_WARNING_NDEV(ndev, WLBT, SCSC_PREFIX fmt, ## args)
#define SCSC_INFO_NDEV(ndev, fmt, args...) \
	SCSC_TAG_INFO_NDEV(ndev, WLBT, SCSC_PREFIX fmt, ## args)
